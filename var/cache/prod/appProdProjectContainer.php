...
class appProdProjectContainer extends Container
{
    ...
    {
        $a = new \Doctrine\ORM\Mapping\Driver\SimplifiedYamlDriver(array(($this->targetDirs[3].'/src/AttendanceRegBundle/Resources/config/doctrine') => 'AttendanceRegBundle\\Entity'));
        $a->setGlobalBasename('mapping');
        $b = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
        $b->addDriver($a, 'AttendanceRegBundle\\Entity');
        $c = new \Doctrine\ORM\Configuration();
        $c->setEntityNamespaces(array('AttendanceRegBundle' => 'AttendanceRegBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_edf59ffcf0b61a046de8230b700a8288ff6cde5f8f1afa43eedcd4b69765b038');
        return $instance;
    }
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/src/AttendanceRegBundle/Resources/views'), 'AttendanceReg');
        $instance->addPath(($this->targetDirs[3].'/src/HrBundle/Resources/views'), 'Hr');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('9012a06af389b8ed83bc3240c905fccc78b6cccd');
    }
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('584c4a28b676f0.00675275')), true);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'AttendanceRegBundle' => 'AttendanceRegBundle\\AttendanceRegBundle',
                'HrBundle' => 'HrBundle\\HrBundle',
            ),
            ...
            'secret' => '9012a06af389b8ed83bc3240c905fccc78b6cccd',
            'locale' => 'en',
            'fragment.renderer.hinclude.global_template' => NULL,
            'fragment.path' => '/_fragment',
            'kernel.secret' => '9012a06af389b8ed83bc3240c905fccc78b6cccd',
